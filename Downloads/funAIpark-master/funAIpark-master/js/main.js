...
class FunAIApp {
    ...
    checkFullAccess() {
        return localStorage.getItem('fullAccessPass') === 'true';
    }
    
    setFullAccess() {
        localStorage.setItem('fullAccessPass', 'true');
            ...
            const resultContent = `
                <div class="result-card">
                    ...
                    <div class="locked-content">
                        ...
                        <div class="unlock-overlay" ${this.hasFullAccess ? 'style="display: none;"' : ''}>
                            <div class="lock-icon">🔒</div>
                            <h4>Your detailed result is ready</h4>
                            <div class="progress-locked">
                                <div class="progress-locked-fill"></div>
                            </div>
                            <p>Unlock in 10 seconds</p>
                            <button class="upgrade-btn" onclick="funaiApp.handleUpgrade()">Unlock for ₹49</button>
                        </div>
                    </div>
                </div>
            `;
    ...
    setupRedFlagTest() {
        // New Red Flag test is handled by red-flag-new.js
        // This method is kept for compatibility
        console.log('Using new Red Flag test');
    }
        ...
        const options = {
            ...
            handler: (response) => {
                ...
                if (testType) {
                    ...
                    // All-access pass
                    this.setFullAccess();
                    alert('🎆 All-Access Pass activated! All premium features unlocked for all tests!');
