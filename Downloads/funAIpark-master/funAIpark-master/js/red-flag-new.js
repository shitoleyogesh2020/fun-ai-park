...
class RedFlagTest {
    constructor() {
        ...
        this.partnerName = '';
        this.questions = [];
        this.hasFullAccess = localStorage.getItem('fullAccessPass') === 'true';
    }
    ...
    showResults() {
        ...
        const html = `
            ...
            <div class="test-content scrollable-content">
                <div class="result-card">
                    ...
                    <button class="upgrade-btn" onclick="upgradeRedFlag()" ${this.hasFullAccess ? 'style="display: none;"' : ''}>
        ...
        if (this.hasFullAccess) {
            setTimeout(() => this.showPremiumContent(), 500);
        }
    }
}
