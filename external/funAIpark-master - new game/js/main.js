...
class FunAIApp {
    ...
    showCharacterResult(type, counts) {
        ...
        const characterQuestions = document.getElementById('characterQuestions');
        const characterResult = document.getElementById('characterResult');
        
        if (characterQuestions) characterQuestions.style.display = 'none';
        if (characterResult) characterResult.style.display = 'block';
        
        const characterAvatar = document.getElementById('characterAvatar');
        const characterType = document.getElementById('characterType');
        const characterDescription = document.getElementById('characterDescription');
        
        if (characterAvatar) characterAvatar.textContent = result.emoji;
        if (characterType) characterType.textContent = result.title;
    ...
    showPremiumCharacterContent() {
        const characterResult = document.getElementById('characterResult');
        if (!characterResult) {
            console.error('Character result element not found');
            return;
        }
        ...
        if (!characterTypeElement || !characterAvatarElement || !characterDescElement) {
            console.error('Character elements not found');
            return;
        }
        
        const currentType = characterTypeElement.textContent;
        const currentEmoji = characterAvatarElement.textContent;
        const currentDesc = characterDescElement.innerHTML;
